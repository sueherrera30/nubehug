        ...
        <nav className="mx-auto flex max-w-7xl items-center justify-between p-4 lg:px-8" aria-label="Global">
          <div className="flex lg:flex-1">
            <Link to="/" className="-m-1.5 p-1.5 flex items-center gap-3 group">
              ...
              />
              <span className="text-2xl font-extrabold text-[#0d47a1] tracking-tight">NubeHug</span>
            </Link>
          </div>
          <div className="hidden lg:flex lg:flex-1 lg:justify-end lg:items-center lg:gap-4">
            {user ? (
              <>
                <Link to="/alianzas" className="text-sm font-bold leading-6 text-emerald-500 hover:text-emerald-600 transition-colors mr-2">
                  Nube Alianzas 🤝
                </Link>
                <Link to="/dashboard" className="text-sm font-bold leading-6 text-[#00bcd4] hover:text-[#029ab0] transition-colors">
                  Mi Dashboard
                </Link>
                <Link to="/academy" className="text-sm font-bold leading-6 text-[#00bcd4] hover:text-[#029ab0] transition-colors">
                  Academy
                </Link>
